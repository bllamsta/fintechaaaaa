...
Route::middleware('auth')->group(function () {
    ...
    Route::get("jajan/setuju/{invoice_id}", function($invoice_id){
        ...
        return redirect()->back()->with("status", "Transaksi disetujui");
    })->name("jajan.setuju");
    ...
    Route::get("jajan/tolak/{invoice_id}", function($invoice_id){
        ...
        return redirect()->back()->with("status", "Transaksi ditolak");
    })->name("jajan.tolak");
    ...
    Route::prefix('menu')->group(function () {
        ...
        Route::post("/add", function(Request $request){
            ...
            return redirect()->back()->with("status", "Berhasil, Tambah Menu");
        })->name("menu.add");

        Route::put("/edit/{id}", function(Request $request, $id){
            Barang::find($id)->update($request->all());

            return redirect()->back()->with("status", "Berhasil, Edit Menu");
        })->name("menu.edit");

        Route::get("/delete/{id}", function($id){
            Barang::find($id)->delete();

            return redirect()->back()->with("status", "Berhasil, Hapus Menu");
        })->name("menu.delete");
    });
