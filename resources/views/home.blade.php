                                        ...
                                        <div class="p-3 border bg-light">
                                            <li style="list-style-type:none">
                                                <a href="{{ route('data_user') }}"
                                                    style="color: black;text-decoration:none;font-size:18px">Data User</a>
                                        </li>
                                        </div>
                                    </div>

                                    <div class="col">
                                    <div class="p-3 border bg-light"><li style="list-style-type: none"><a href="{{ route('data_transaksi') }}"
                                        style="color: black;text-decoration:none;font-size:18px">Transaksi</a></li></div>
                                    </div>
                                </div>
                                </div>
                            </ul>
                        ...
                        @if (Auth::user()->role_id === 4)
                            <ul>
                                <div class="row gx-5">
                                    ...
                                    <div class="col">
                                    <div class="p-3 border bg-light"><li style="list-style-type: none"><a href="{{ route('transaksi') }}"
                                        style="color: black;text-decoration:none;font-size:18px">Transaksi</a></li></div>
                                    </div>
                                </div>
                                </div>
